# flutter_grid_info
Aplicativo Flutter para registro de informações e gráfico com dados das edições.
...
1.  **Clone o repositório:**
   ```bash
   git clone [https://github.com/AmandaFonseca/flutter_grid_info](https://github.com/AmandaFonseca/flutter_grid_infot)
    ```
