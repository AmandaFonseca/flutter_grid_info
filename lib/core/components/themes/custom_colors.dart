...
class CustomColors {
  ...
  static Color spaceBlue = Color(0xFF355C7D);
  static Color cosmicPurple = Color(0xFF6C5B7B);
  static Color nebulaPink = Color(0xFFC06C84);
  static Color neonGreen = Color(0xFF81ff8a);
  static Color neonDarkGreen = Color(0xFF64965e);
  static Color orangeDark = Color.fromARGB(255, 255, 140, 0);
}
